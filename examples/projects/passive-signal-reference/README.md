...
From the repository root, run `kicad-team ci --project passive-signal-reference`. Optional Python
tests in this folder run automatically. Native checks use
`kicad-team ci --kicad --project passive-signal-reference --output examples/projects/passive-signal-reference/build/review-001`.
