...
from tools.hwrepo.electrical_charts import build_charts, build_suite
...
class ElectricalChartsTests(unittest.TestCase):
    ...
    def test_changed_or_unrecorded_waveform_cannot_be_plotted(self) -> None:
        ...
        with patch("tools.hwrepo.electrical_charts.render_case") as renderer:
            result = build_charts(self.root, self.source)
    ...
    def test_source_mutation_during_render_rejects_output_report(self) -> None:
        self.complete()
        from tools.hwrepo.electrical_plot import render_case
        ...
        with (patch("tools.hwrepo.electrical_charts.render_case", side_effect=change_after_render),
    ...
    def test_cli_exports_existing_receipt_as_machine_json(self) -> None:
        self.complete()
        command = subprocess.run((sys.executable, "-B", "-m", "tools.electrical_charts",
