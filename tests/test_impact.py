...
from tools.hwrepo.impact import plan_paths
...
class ImpactPlanTests(unittest.TestCase):
    ...
    def test_project_local_declared_markdown_input_is_source(self) -> None:
        ...
        with patch("tools.hwrepo.impact.read_model", side_effect=synthetic_manifest):
            for path in (
    ...
    def test_product_evidence_markdown_is_a_product_input(self) -> None:
        ...
        with patch("tools.hwrepo.impact.read_model", side_effect=synthetic_product):
    ...
    def test_library_license_markdown_outside_library_tree_selects_consumers(self) -> None:
        ...
        with patch("tools.hwrepo.impact.read_model", side_effect=synthetic_catalog):
    ...
    def test_configured_catalog_path_is_global_even_if_moved_under_docs(self) -> None:
        ...
        with patch("tools.hwrepo.impact.load_registry", return_value=registry.model_copy(
