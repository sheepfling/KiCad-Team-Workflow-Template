...
from tools.hwrepo.inventory import inventory
from tools.hwrepo.models import ProductIndex, ProjectDiscovery, ProjectKind
...
class InventoryTests(unittest.TestCase):
    ...
    def test_cli_keeps_json_structured_and_text_scannable(self) -> None:
        root = reference_root()
        with (
            patch.object(sys, "argv", ["tools.template", "list", "--root", str(root)]),
